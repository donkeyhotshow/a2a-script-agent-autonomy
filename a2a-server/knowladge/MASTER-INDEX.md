...
### hybrid/
Гибридные действия (script → agent → script)

### mechanical/
Механические действия (полностью автоматические)

### ollama/
LLM действия через Ollama

### yolo/
YOLO режим (быстрые действия)
...
| Файл | Действий | script | agent | agent |
|------|----------|--------|--------|-------|
...
### 1. mechanical (script)
Полностью автоматические операции без LLM:
- File Operations
- Search Operations
...
### 2. hybrid
Комбинированные (script → agent → script):
...
### Подпапки
- **hybrid/** - Гибридные действия
- **mechanical/** - Механические действия
- **ollama/** - LLM действия
- **yolo/** - YOLO режим
