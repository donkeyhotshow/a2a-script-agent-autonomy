...
// Define log format
const logFormat = winston.format.combine(winston.format.timestamp({ format: "YYYY-MM-DD HH:mm:ss" }), winston.format.errors({ stack: true }), winston.format.splat(), config.logFormat === "pretty"
    ...
    : winston.format.json());
const consoleFormat = config.logFormat === "pretty"
