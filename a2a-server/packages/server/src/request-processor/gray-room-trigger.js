...
function isGrayRoomExplicitlyDisabled() {
...
function resolveFlowControlHint(ctx, flowControlHint) {
 ...
 */
function computeGrayRoomTrigger(ctx, flowControlHint) {
 ...
 */
export function detectGrayRoomTrigger(ctx) {
 ...
 */
export function isGrayRoomEnabled() {
    return getGrayRoomEnabled();
}
/**
 * Get current gray room max turns (for diagnostics)
 */
export function getConfiguredMaxTurns() {
    return getGrayRoomMaxTurns();
}
//# sourceMappingURL=gray-room-trigger.js.map