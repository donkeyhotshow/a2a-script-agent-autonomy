...
const contextParser = {
    ...
    // Context is client-owned and may be minimal. We only require "object" here.
    isValidContext: (context: unknown): context is Record<string, unknown> => {
...
describe('Context Parser', () => {
    describe('parseContextBlock', () => {
        it('should parse valid context object', () => {
            const context = {task: 'hello', metadata: {x: 1}};
    ...
    describe('serializeContext / deserializeContext', () => {
        it('should serialize and deserialize context', () => {
            const context = {task: 't', metadata: {key: 'value'}};
