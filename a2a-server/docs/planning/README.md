...
**Специфікація протоколу (не плутати з планом):** детальні контракти та JSON Schema — у [`docs/new-request-flow/`](../../../docs/new-request-flow/README.md): [`PROTOCOL.md`](../../../docs/new-request-flow/PROTOCOL.md), [`json-schemas/README.md`](../../../docs/new-request-flow/json-schemas/README.md), [`PROTOCOLS/README.md`](../../../docs/new-request-flow/PROTOCOLS/README.md). Після змін у коді оновлюйте симуляції в [`simulations/`](../../../simulations/) і при потребі ці документи.
...
- [LLM-REQUEST-PREP.md](LLM-REQUEST-PREP.md) — коротка планувальна нотатка; канон: [`../LLM-REQUEST-PREP.md`](../LLM-REQUEST-PREP.md)
