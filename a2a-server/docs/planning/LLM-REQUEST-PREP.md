...
**Канон (деталі, шляхи від `a2a-server/`, тести, related docs):** [`../LLM-REQUEST-PREP.md`](../LLM-REQUEST-PREP.md).

**AI-action патерн (execute / transforms):** [`../AI-ACTION-TRANSFORM-PATTERN.md`](../AI-ACTION-TRANSFORM-PATTERN.md).
...
- [`ADR-0026-server-llm-request-prep.md`](../../../docs/adr/ADR-0026-server-llm-request-prep.md) — формальне рішення (ADR).
