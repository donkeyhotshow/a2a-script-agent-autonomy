...
1. **execute.form.choices** — частично реализовано в [`action-request-processor.ts`](../../src/services/core/request-processor/action-request-processor.ts:232)
2. **Action-key shape** — типы [`ExecuteCommand`](../../src/types/index.ts:136) и [`ResultCommand`](../../src/types/index.ts:209) определены
3. **PromiseId async flow** — реализован в [`ollama-adapter.ts`](../../src/services/ai/ollama-adapter.ts) и request service
4. **Timer-based polling** — REQUEST_PROCESSOR_INTERVAL_MS (по умолчанию 5 секунд)
5. **Context Block** — [`ContextBlock`](../../src/types/index.ts:14) с полями `execution.action`, `execution.step`
6. **Actions vs AI-Actions** — разделение в [`ActionRequestProcessor`](../../src/services/core/request-processor/action-request-processor.ts) и [`PhaseMachine`](../../src/services/core/context/context-manager.service.ts:468)
...
**Файлы:**
- [`types/index.ts`](../../src/types/index.ts) — расширить ExecuteCommand
- [`services/core/request-processor/base-processor.ts`](../../src/services/core/request-processor/base-processor.ts) — добавить обработку типов
- [`services/core/context/context-manager.service.ts`](../../src/services/core/context/context-manager.service.ts) — PhaseMachine для AI-Actions
...
**Файлы:**
- Создать [`services/core/transform/transform-pipeline.service.ts`](../../src/services/core/transform/transform-pipeline.service.ts)
- Обновить [`services/core/request-processor/neuron-request-processor.ts`](../../src/services/core/request-processor/neuron-request-processor.ts)
...
**Файлы:**
- [`services/core/request-processor/action-request-processor.ts`](../../src/services/core/request-processor/action-request-processor.ts:232)
- [`services/core/request-processor/neuron-request-processor.ts`](../../src/services/core/request-processor/neuron-request-processor.ts)
- [`types/index.ts`](../../src/types/index.ts:93)
...
**Файлы:**
- [`types/index.ts`](../../src/types/index.ts) — ServerMessage
...
**Файлы:**
- Создать [`services/core/validation/schema-validator.service.ts`](../../src/services/core/validation/schema-validator.service.ts)
- Обновить [`routes/index.ts`](../../src/routes/index.ts:38) — добавить валидацию
- Обновить [`services/core/request-processor/base-processor.ts`](../../src/services/core/request-processor/base-processor.ts)
...
**Файлы:**
- [`services/core/context/context-manager.service.ts`](../../src/services/core/context/context-manager.service.ts:468) — PhaseMachine
- [`services/core/request-processor/neuron-request-processor.ts`](../../src/services/core/request-processor/neuron-request-processor.ts)
...
**Файлы:**
- [`services/ai/llm-adapter.ts`](../../src/services/ai/llm-adapter.ts)
- Создать [`services/core/transform/request-transformer.ts`](../../src/services/core/transform/request-transformer.ts)
- Создать [`services/core/transform/response-transformer.ts`](../../src/services/core/transform/response-transformer.ts)
