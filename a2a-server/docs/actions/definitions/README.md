...
Actions - это человекопонятные сжатые инструкции для интерпретации системой через compat_llm (rnj-1).
...
Local LLM upstream (rnj-1) ищет подходящий action по семантике description. Индекс категорий: `auto-ai-index.ts`.
