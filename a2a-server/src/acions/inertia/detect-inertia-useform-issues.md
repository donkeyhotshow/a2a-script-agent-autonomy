...
| Параметр | Значение |
|----------|----------|
| actionId | detect-inertia-useform-issues |
| categoryId | inertia |
| executorSystemId | script |
| title | Детекция проблем useForm |
| stack | laravel-vue |
| canMigrateToScript | ✅ |

## Описание

Скрипт детектирует проблемы с использованием useForm в Inertia.js компонентах.

## Типы проблем

- Неправильная инициализация useForm
- Отсутствие обработки ошибок
- Проблемы с валидацией
- Неправильное использование isDirty
- Проблемы с reset()
- Отсутствие loading state

## Анализируемые файлы

- Vue компоненты с useForm
- Компоненты форм
