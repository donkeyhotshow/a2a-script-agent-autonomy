 ...
 * Supports operations: copy, set, append-to-array, parse-json-from-md, render-markdown, switch, apply-scratchpad-ops, truncate-section, pick-context, drop, truncate-history, include-if, pick-files
 * 
 * @example
 * ```typescript
