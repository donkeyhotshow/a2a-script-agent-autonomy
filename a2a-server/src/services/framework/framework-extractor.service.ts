 ...
 *
 * @deprecated Use framework-detector.service.ts instead
 * 
 * Extracts framework information from code blocks and project structure.
 * Supports Vue.js, React, Laravel, and TypeScript detection.
 */
