 ...
 * 
 * Реализация управления контекстом запроса на сервере
 */
...
export class ContextManager {
    ...
    /**
     * Оценить размер данных (публичный метод для десериализации)
     */
    public estimateSizePublic(data: unknown): number {
        return this.estimateSize(data);
    }
}
