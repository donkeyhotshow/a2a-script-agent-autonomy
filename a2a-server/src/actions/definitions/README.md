...
| Что                                  | Где                                                                                                                                                                                                                                                                              |
|--------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| План new request flow                | [plans/a2a-server-new-request-flow.md](../../../../plans/a2a-server-new-request-flow.md)                                                                                                                                                                                         |
| fix-vue-imports (альтернативы)       | [plans/fix-vue-imports-alternatives-design.md](../../../../plans/fix-vue-imports-alternatives-design.md)                                                                                                                                                                         |
