...
| Что                                  | Где                                                                                                                                                                                                                                                                              |
|--------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| План new request flow (архив)        | [a2a-server/docs/plans-archive/a2a-server-new-request-flow.md](../../../docs/plans-archive/a2a-server-new-request-flow.md)                                                                                                                                                         |
| fix-vue-imports (альтернативы)       | [a2a-server/docs/plans-archive/fix-vue-imports-alternatives-design.md](../../../docs/plans-archive/fix-vue-imports-alternatives-design.md)                                                                                                                                         |
