...
**Promise behavior:** Dialog pipeline errors that can recover typically **re-queue the same `promiseId`** instead of immediate `failed`. See **[`../docs/PROMISE-RETRY-DIALOG.md`](../docs/PROMISE-RETRY-DIALOG.md)**.
