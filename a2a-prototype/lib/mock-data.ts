...
export const MOCK_ARTIFACTS: ArtifactBase[] = [
  ...
  {
    artifact_id: 'POLICY_VIOLATION.sess_1743530400_abc1.turn_010',
    ...
    schema_version: '1.0',
    severity: 'critical',
    summary: 'Policy P002 blocked: direct execution on protected branch',
    data: {
      policy_id: 'P002',
      severity: 'block',
  ...
  {
    artifact_id: 'JUDGMENT_RESULT.sess_1743530400_abc1.turn_011',
    artifact_type: 'JUDGMENT_RESULT',
    session_id: 'sess_1743530400_abc1',
    turn_id: 'turn_011',
    created_at: '2026-04-01T20:12:00Z',
    schema_version: '1.0',
    severity: 'info',
    summary: 'LLM judge: approved (score 0.82)',
    data: {
      ...
      blocking_issues: [],
      approved: true,
      judge_reasoning: 'Output addresses all goal criteria',
    },
  },
  {
    artifact_id: 'TOOL_PROFILE.sess_1743530400_abc1.turn_012',
    artifact_type: 'TOOL_PROFILE',
    session_id: 'sess_1743530400_abc1',
    turn_id: 'turn_012',
    created_at: '2026-04-01T20:13:00Z',
    schema_version: '1.0',
    severity: 'info',
    summary: 'Tool profile: grep-search (94% success, p95=380ms)',
    data: {
      ...
      p95_duration_ms: 380,
      trending: 'stable',
      best_fsm_states: ['EXECUTING', 'SCANNING'],
    },
  },
];
