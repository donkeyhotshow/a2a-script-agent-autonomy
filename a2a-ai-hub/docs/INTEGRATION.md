...
> 
> **См.:** [ARCHITECTURE.md](../docs/ARCHITECTURE.md), [PROTOCOL.md](../docs/PROTOCOL.md)

## Общая диаграмма потока данных

Головная диаграмма стека (Web → Client API → A2A Server → Hub, порты) — **[DATA-FLOW.md](../docs/DATA-FLOW.md)** — здесь не дублируется.
...
Симуляции используются как "золотые следы" (golden traces) for testing and воспроизведения поведения системы.
...
**Action-key shape**, эндпоинты и примеры — **[PROTOCOL.md](../docs/PROTOCOL.md)**. Перечень действий по типам — **[PROTOCOL/actions/README.md](../docs/PROTOCOL/actions/README.md)**.
...
См. [json-schemas/](json-schemas/) и [SCHEMAS.md](../docs/SCHEMAS.md):
...
ARCHITECTURE.md
    ...
    └──▶ INTEGRATION.md (this file)
            │
            ├──▶ Диаграммы сессии / действий (below in file)
            └──▶ json-schemas/
```
