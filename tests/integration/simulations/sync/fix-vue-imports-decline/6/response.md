# `fix-vue-imports-decline/6` — response
...
{
  "context": {
    "task": "Доробити невирішені Vue-импорти вручну (після часткового скрипта)",
    "execution": {
      "action": "task",
      "step": "router"
    },
    ...
    "vue_imports_partial_carryover": true,
    "previous_action_attempt": "fix-vue-imports"
  },
  "execute": {
    "form": {
      "title": "Оберіть спосіб виконання",
      "description": "Нова задача збережена в context.task; unresolved_imports з попередньої спроби лишаються в контексті.",
      "choices": [
        {
          "id": "dialog",
