...
/** Repo-root `simulations/` (two levels up from this file: scripts → simulations). */
export const SIMULATIONS_DIR = join(__dirname, '..', '..');

/**
 * Full original content from a2a-server/scripts/sim-validate/scanner.ts with path update.
 */
