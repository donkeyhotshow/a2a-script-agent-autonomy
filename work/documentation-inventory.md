...
- `NEW-AGENTS.md` - Updated agent instructions
- `TODO.md` - Current tasks and TODOs
- `TODO-fix-vue-imports.md` - Vue imports fix tasks
...
- `.clinerules/workflows/DOCUMENTATION-PROCESS.md` - Current workflow (this file)
- `.clinerules/workflows/INTEGRATION-STRATEGY.md` - Integration strategy
- `.clinerules/workflows/SCRIPT-SYSTEM-PROCESS.md` - Script system process
...
- `.clinerules/scripts/test-review-workflow.js` - Test suite
...
- `.kilocode/workflows/SERVER-SIMULATION-WORKFLOW.md` - Server simulation workflow
- `.kilocode/workflows/SIMULATION-WORKFLOW.md` - General simulation workflow
...
- `a2a-client/docs/archive/client-packages-ts-migration-and-src-merge.md` - TypeScript migration
- `a2a-client/docs/archive/client-server-communication-options.md` - Communication options
- `a2a-client/docs/archive/frontend-session-approval-flow-plan.md` - Session approval flow
- `a2a-client/docs/archive/frontend-session-history-plan.md` - Session history plan
- `a2a-client/docs/archive/frontend-session-history-recovery-plan.md` - Session history recovery
- `a2a-client/docs/archive/frontend-unified-json-plan.md` - Unified JSON plan
- `a2a-client/docs/archive/plasticine-ui-todos.md` - UI todos
- `a2a-client/docs/archive/simulation-framework-plan.md` - Simulation framework
- `a2a-client/docs/archive/unified-json-frontend-framework-plan.md` - Unified frontend framework
- `a2a-client/docs/archive/unified-ui-plan.md` - Unified UI plan
...
- `a2a-client/packages/rag/README.md` - RAG package
- `a2a-client/packages/script-runner/README.md` - Script runner package
- `a2a-client/packages/terminal/README.md` - Terminal package
...
- `a2a-client/web/MISSING-FUNCTIONALITY.md` - Missing functionality
- `a2a-client/web/TODO-implementation.md` - Implementation TODOs
- `a2a-client/web/TODO-improve.md` - Improvement TODOs
...
- `a2a-server/docs/NEW-entry-points.md` - Updated entry points
...
- `new-request-flow/FILES.md` - File documentation
- `new-request-flow/IMPLEMENTATION-STATUS.md` - Implementation status
- `new-request-flow/PROTOCOL.md` - Protocol documentation
- `new-request-flow/ROADMAP.md` - Roadmap
- `new-request-flow/SCHEMAS.md` - Schema documentation
- `new-request-flow/SESSION-FLOW.md` - Session flow
- `new-request-flow/SIMULATION-ANALYSIS.md` - Simulation analysis
- `new-request-flow/SIMULATION-CODER-DIALOG.md` - Coder dialog simulation
- `new-request-flow/SIMULATION-FIX-VUE-IMPORTS.md` - Vue imports fix simulation
- `new-request-flow/SIMULATION-FORMAT.md` - Format simulation
- `new-request-flow/SIMULATION-LLM-PROXY.md` - LLM proxy simulation
...
- `dnd/NODES.md` - Nodes documentation
- `dnd/PACKAGES.md` - Packages documentation
- `dnd/SCRIPTS.md` - Scripts documentation
- `dnd/SERVICES.md` - Services documentation
- `dnd/SOLUTIONS.md` - Solutions documentation
- `dnd/SYSTEMS.md` - Systems documentation
- `dnd/TASKS.md` - Tasks documentation
...
- `docs/NEW-TEST-cli-documentation.md` - CLI documentation test
- `docs/README-Extract-Classes.md` - Extract classes documentation
- `docs/README-FULL.md` - Full documentation
- `docs/README-PHP-and-Testing-Rules.md` - PHP and testing rules
- `docs/README-PowerShell-Rules.md` - PowerShell rules
- `docs/README-Styling-Rules.md` - Styling rules
...
- `docs/cline/NEW-TEST-cli-documentation.md` - CLI documentation test
- `docs/cline/REVIEW-WORKFLOW-SUMMARY.md` - Review workflow summary
- `docs/cline/INTEGRATION-GUIDE.md` - Integration guide
- `docs/cline/DOCUMENTATION-REVIEW-WORKFLOW.md` - Documentation review workflow
...
- `plans/pivot-3-implementation-plan.md` - Implementation plan
...
- `work/documentation-inventory.md` - This inventory file

## Node Modules Documentation

### A2A Client Dependencies

- `a2a-client/node_modules/` - Client dependencies documentation (1000+ files)

### A2A Server Dependencies

- `a2a-server/node_modules/` - Server dependencies documentation (600+ files)

## Notes

- This inventory includes all .md, .txt, and .docx files found in the project
- Node modules documentation is extensive but mostly auto-generated
- Focus should be on project-specific documentation in the main directories
- Archive documentation may need review for current relevance
- Simulation documentation contains detailed analysis and workflows