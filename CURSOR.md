...
- Run terminal commands to verify before closing
- Always start the stack from repo root: `npm run dev`
- Check service health before running monitor: `curl http://localhost:3000/health`
