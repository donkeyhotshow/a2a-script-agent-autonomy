 ...
 * Types for Web UI
 * 
 * Defines the session model structure used in the Web UI
...
/**
 * Sanitize session data for Web UI
 */
export function sanitizeSessionForWeb(session) {
