...
const CommandPalette = {
  ...
  registerDefaultCommands() {
    this.commands = [
      ...
      { id: 'open-file', label: 'Open File', category: 'File', action: () => document.getElementById('docOpenForm')?.dispatchEvent(new Event('submit')) },
      ...
      { id: 'redo', label: 'Redo', category: 'Edit', shortcut: 'Ctrl+Shift+Z', action: () => window.appState?.redo?.() },
      { id: 'copy-node', label: 'Copy Node', category: 'Edit', shortcut: 'Ctrl+C', action: () => this.copySelectedNode() },
      { id: 'paste-node', label: 'Paste Node', category: 'Edit', shortcut: 'Ctrl+V', action: () => this.pasteNode() },
      { id: 'delete-node', label: 'Delete Node', category: 'Edit', shortcut: 'Delete', action: () => this.deleteSelectedNode() },
      { id: 'duplicate-node', label: 'Duplicate Node', category: 'Edit', action: () => this.duplicateSelectedNode() },

      // View commands
      { id: 'zoom-in', label: 'Zoom In', category: 'View', shortcut: 'Ctrl++', action: () => window.flowManager?.zoomIn?.() },
      { id: 'zoom-out', label: 'Zoom Out', category: 'View', shortcut: 'Ctrl+-', action: () => window.flowManager?.zoomOut?.() },
      { id: 'fit-view', label: 'Fit View', category: 'View', shortcut: 'Ctrl+0', action: () => window.flowManager?.fitView?.() },
      { id: 'toggle-minimap', label: 'Toggle Minimap', category: 'View', action: () => this.toggleMinimap() },

      // Flow commands
      { id: 'new-task', label: 'New Task', category: 'Flow', shortcut: 'Ctrl+N', action: () => this.showModal('taskModal') },
      ...
      { id: 'sessions', label: 'Manage Sessions', category: 'Settings', action: () => this.showModal('sessionsModal') },
      { id: 'projects', label: 'Manage Projects', category: 'Settings', action: () => this.showModal('projectsModal') },
