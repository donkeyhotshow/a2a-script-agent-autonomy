        ...
        proposedActions: [
          {
            ...
            matchScore: 0.95,
            subActions: [
              { actionId: 'vue-import-detect', title: 'Определить сломанные импорты', description: '', priority: 10, input: 'none', output: '' },
              { actionId: 'vue-import-resolve', title: 'Разрешить пути', description: '', priority: 9, input: '', output: '' },
              { actionId: 'vue-import-apply', title: 'Применить исправления', description: '', priority: 8, input: '', output: '' }
            ]
          }
        ],
        executingAction: {
