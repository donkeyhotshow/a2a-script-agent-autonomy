...
- Protocol: `docs/PROTOCOL.md` and any simulation folder under `simulations/` describe how `context.history` is packed into `request.json`/`request.md` and how `execute` flows back to the UI.
