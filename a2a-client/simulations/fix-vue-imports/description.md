...
This simulation demonstrates a **server-controlled workflow** where the server defines the exact sequence of steps. The
client executes each step and returns results, without making autonomous decisions.
