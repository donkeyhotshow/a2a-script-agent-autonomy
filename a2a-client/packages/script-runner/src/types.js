/**
 * Types for Script Runner
 * 
 * Defines the session model structure used in the Script Runner package
 * Matches the server-side session model with context, execute, status, exchangeLog[], messages[]
 */

/**
 * Session model for Script Runner
 */
...
/**
 * Sanitize session data for Script Runner
 */
export function sanitizeSessionForScriptRunner(session) {
