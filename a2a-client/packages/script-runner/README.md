...
Пакет для безопасного выполнения TypeScript/JavaScript кода в изолированной sandbox-среде (VM2). Используется для выполнения скриптов из MD-файлов действий на клиенте a2a-client.
