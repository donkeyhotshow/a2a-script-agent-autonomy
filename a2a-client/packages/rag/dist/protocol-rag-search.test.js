...
const protocol_rag_search_1 = require("./protocol-rag-search");
describe('toRagSearchResult', () => {
    ...
    it('should transform results to protocol format', () => {
        const result = (0, protocol_rag_search_1.toRagSearchResult)(mockResults, { query: 'auth system' });
    ...
    it('should limit number of files', () => {
        const result = (0, protocol_rag_search_1.toRagSearchResult)(mockResults, { maxFiles: 2 });
        expect(result.files).toHaveLength(2);
        expect(result.results).toHaveLength(2);
    });
    ...
    it('should group by file and take best result', () => {
        ...
        const result = (0, protocol_rag_search_1.toRagSearchResult)(duplicateResults, { maxFiles: 3 });
    ...
    it('should handle empty results', () => {
        const result = (0, protocol_rag_search_1.toRagSearchResult)([], { query: 'empty test' });
