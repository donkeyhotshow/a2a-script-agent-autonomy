/**
 * result["rag-search"] shape for protocol – stub.
 * Task: tasks/client/03-rag-package-simulation-and-policy-alignment.md
 *
 * TODO(03): transform search results to { results: [{ file, path, score, snippet }], files?: string[], query? }
 * TODO(03): policy: max results, allowed dirs/extensions (Task 39)
 */
