/**
 * Meilisearch Client (shared between SDK and RAG packages).
 *
 * Provides a lightweight wrapper around Meilisearch HTTP API.
 */
...
export class MeilisearchClient {
  ...
  indexName: string;
  // For SDK compatibility - RAG package doesn't use this
  index: unknown = null;
  initialized = false;
