/**
 * Types for API Server
 * 
 * Defines the session model structure used in the API Server package
 * Matches the server-side session model with context, execute, status, exchangeLog[], messages[]
 */

/**
 * Session model for API Server
 */
...
/**
 * Sanitize session data for API Server
 */
export function sanitizeSessionForAPIServer(session) {
