 ...
 * Types for History
 * 
 * Defines the session model structure used in the History package
 * Matches the server-side session model with context, execute, status, exchangeLog[], messages[]
 */

/**
 * Session model for History
 */
...
/**
 * Sanitize session data for History
 */
export function sanitizeSessionForHistory(session) {
