            ...
            sendHttpRequest({
                ...
                onResponse: async (xhrRes, data) => {
                    try {
                        ...
                        const serverOnRouterBeat = postExec &&
                        ...
                        respondJsonOnce(res, 500, detail ? { error: 'Internal server error', detail } : { error: 'Internal server error' });
                    }
                },
                onError: (e) => {
                    try {
                        const detail = (e && (e.message || e.code)) ||
                            (typeof e === 'string' ? e : '') ||
                            String(e);
