 ...
 *
 * Input: web-facing payload (simulations `received.json`, GET /sessions response).
 ...
 *
 * @param {Object|null} payload - received.json shape: may contain top-level `execute` or nested `session.execute`.
 */
