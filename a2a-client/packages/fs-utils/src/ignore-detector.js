 ...
 * 
 * Полная совместимость с packages/agent/src/ignore-detector.js
 */
...
class IgnoreDetector {
   ...
   * @param {string[]} [config.additionalPatterns] - Additional patterns to ignore
   */
  constructor(config = {}) {
   ...
   * @returns {Promise<IgnoreDetector>}
   */
  async initialize() {
  ...
  shouldSkipDirectory(dirName, parentPath = '') {
    // Check common ignored directories first
