 ...
 * Types for FS Utils
 * 
 * Defines the session model structure used in the FS Utils package
 * Matches the server-side session model with context, execute, status, exchangeLog[], messages[]
 */

/**
 * Session model for FS Utils
 */
...
/**
 * Sanitize session data for FS Utils
 */
export function sanitizeSessionForFSUtils(session) {
