 ...
 * Types for Terminal
 * 
 * Defines the session model structure used in the Terminal package
 * Matches the server-side session model with context, execute, status, exchangeLog[], messages[]
 */

/**
 * Session model for Terminal
 */
...
/**
 * Sanitize session data for Terminal
 */
export function sanitizeSessionForTerminal(session) {
