...
- **`N-sub-M/`** (optional folder next to step `N/`, `M` = 1,2,…) — e.g. [`auto-ai-v2/6-sub-1/`](./auto-ai-v2/6-sub-1/) … [`6-sub-4/`](./auto-ai-v2/6-sub-4/) for `interruptTrace` variants (`trace.json`). See [`SCHEMA.md`](./SCHEMA.md#supplementary-server-interrupt-loop-optional).
