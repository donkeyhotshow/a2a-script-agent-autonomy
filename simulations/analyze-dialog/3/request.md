...
Одна дія за раз. Для пошуку документів по архітектурі використовуй rag-search з query (наприклад: "архітектура бекенд сервіси API слої").
...
```json
{
  ...
  "result": { "action": "analyze-architecture", "message": "опиши поточну архітектуру бекенду" }
}
```
