...
- **LLM backends (Z.AI vs Local LLM upstream):** goldens are synthetic; see [`../LLM-BACKEND-MAP.md`](../LLM-BACKEND-MAP.md) for runtime vs fixtures and optional `request.md` headers.
