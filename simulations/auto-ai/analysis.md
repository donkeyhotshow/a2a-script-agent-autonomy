...
Validate orchestration and context when the AI runs a long chain: multiple read-file, multiple write-file, list-directory, grep-search, two execute-commands, then report and completed.
