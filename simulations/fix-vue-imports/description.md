...
Це симуляція типу **Actions** — сервер веде кроки; після resolve можливий **частковий** результат і перехід у **Coder** або залишити як є.
...
Другий сценарій (відмова від Coder, повернення до роутера + нова задача): [`fix-vue-imports-decline`](../fix-vue-imports-decline/description.md).
