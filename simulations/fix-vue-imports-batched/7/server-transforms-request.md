# Server: request → response (step 7)

**Input:** `request.json` = `{ "context": { "execution": { "step": "search-exporter", "progress": { "currentFile": 2 } } }, "result": { "file": "...", "fixed": true, "patch": {...} } }`.
...
4. Increment progress: `currentFile: 3`.
