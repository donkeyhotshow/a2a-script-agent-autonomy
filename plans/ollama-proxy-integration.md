...
- [ ] [Настроить external-ai-hub на порту 11434](#настроить-external-ai-hub-на-порту-11434)
- [ ] [Создать OllamaAdapter с promise-based интерфейсом](#создать-ollamaadapter-с-promise-based-интерфейсом)
- [ ] [Реализовать polling механизм](#реализовать-polling-механизм)
- [ ] [Обновить LLM сервис для использования асинхронного режима](#обновить-llm-сервис-для-использования-асинхронного-режима)
- [ ] [Добавить конфигурацию таймаутов и интервалов](#добавить-конфигурацию-таймаутов-и-интервалов)
- [ ] [Написать тесты](#написать-тесты)
