...
## Цель
Создать веб-интерфейс для отображения первого запроса с `promiseId`, требующего ответа, с возможностью копирования запроса, выполнения/вставки ответа и одобрения.

## Архитектура

```mermaid
graph TB
    subgraph "external-ai-hub"
...
[
  {
    ...
    "method": "POST",
    "path": "/api/generate",
    "target_url": "http://localhost:11435/api/generate",
...
1. **external-ai-hub/proxy.py** - добавить новые endpoints
2. **external-ai-hub/web/promise-viewer.html** - создать HTML страницу
