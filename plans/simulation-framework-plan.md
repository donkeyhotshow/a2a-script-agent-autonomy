...
**Ключове правило:**
- `response.json` - очікувана відповідь (еталон)
- `server-response.json` - реальна відповідь сервера (для порівняння)
...
- **response.json** - еталонна відповідь (коммітимо в git)
- **server-response.json** - реальна відповідь сервера (.gitignore)
