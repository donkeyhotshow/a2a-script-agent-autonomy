...
| **Live stack bootstrap** | **`start-all.bat`** from repo root for full stack control ([`SYSTEM_STARTUP.md`](../infrastucture/docs/SYSTEM_STARTUP.md)) |
...
Operator walkthrough (Client API, router beats, iteration traps), A2A protocol, env/ports, API tables, debugging, testing, common issues, ADRs, glossary slice, DEV_STATE protocol detail, operational checklist: **[`AGENTS-REFERENCE.md`](AGENTS-REFERENCE.md)**.

Driver checklist and curl narrative: **[`OPERATOR-CURL.md`](../runbook/docs/OPERATOR-CURL.md)**.

**Archived from:** root AGENTS.md (2024-10, DOC-STATE reorganization).
