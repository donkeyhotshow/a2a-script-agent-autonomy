...
**Definitions (MD в репо):
** [fix-vue-imports.md](../../a2a-server/src/actions/definitions/fix-vue-imports.md) · [fix-vue-imports-batch.md](../../a2a-server/src/actions/definitions/fix-vue-imports-batch.md) · [definitions/README.md](../../a2a-server/src/actions/definitions/README.md)
...
- [ ] Реализовать fix-vue-imports-batch.md
- [ ] Создать MD файл с sub-actions
- [ ] Добавить серверную логику обработки
- [ ] Реализовать state machine на контексте
- [ ] Добавить поддержку условий в action-parser
- [ ] Расширить ServerMessage типы
- [ ] Добавить тесты
