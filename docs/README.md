...
| Документ | Назначение |
|----------|------------|
| [architecture-principles.md](architecture-principles.md) | **Главный принцип:** сервер не хранит данные клиента. Граф в контексте. |

---

## Модернизация нейронов

| Документ | Назначение |
|----------|------------|
 | [neuron-modernization.md](neuron-modernization.md) | **Новая архитектура:** new_task → TaskDetailAnalyzer → tasks[], уровни детализации, итеративная обработка |
