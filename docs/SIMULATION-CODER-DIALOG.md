...
│  - Повертає top-level result (completion)                            │
└─────────────────────────────────────────────────────────────────────┘
```

## Огляд

Ця симуляція демонструє повний потік виконання екшена з **новим стандартом роутера**:
...
8. Server виконує дію на клієнті
9. LLM продовжує з контекстом результатів
10. Цикл повторюється до завершення
...
### Крок 2: Вибір екшена через form.choices
