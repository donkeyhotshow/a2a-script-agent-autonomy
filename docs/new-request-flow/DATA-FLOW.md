...
│  │  │                           Роутинг                                        │  │  │
│  │  │  ┌──────────────┐  ┌──────────────┐  ┌───────────┐  ┌───────────┐           │  │  │
│  │  │  │/api/a2a/sess*│  │/api/a2a/proj│  │ /api/v1/* │  │ /api/fs/* │           │  │  │
│  │  │  └─────┬─────┘  └─────┬─────┘  └─────┬─────┘  └─────┬─────┘           │  │  │
│  │  └────────│───────────────│───────────────│───────────────│─────────────────┘  │  │
│  │           │               │               │               │                   │  │
│  │           ▼               ▼               ▼               ▼                   │  │
...
│  │  │  - workbench     : Структурированное состояние (sections / batch / slots)  │   │ │
...
| AI Hub (ai-integration) | 11434 | Прокси / promise flow | → Ollama (11435) |
| Ollama | 11435 | Локальная LLM | — |

## Перекрёстные ссылки

- [INTEGRATION.md](INTEGRATION.md) — Дополнительные диаграммы (состояния сессии, симуляции), быстрый старт
