...
| suggest-inertia-router-fix | inertia | compat_llm | Предложение исправления router | laravel-vue | ✅ |
...
| suggest-inertia-preservestate-fix | inertia | compat_llm | Предложение preserveState/preserveScroll | laravel-vue | ✅ |
...
| suggest-vue-composition-fix | vue | compat_llm | Предложение Composition API | vue | ✅ |
| detect-vue-defineprops-emits | vue | script | Детекция defineProps/defineEmits | vue | ✅ |
| suggest-vue-props-emits-fix | vue | compat_llm | Предложение исправления props/emits | vue | ✅ |
| detect-vue-lifecycle-issues | vue | script | Детекция нарушений lifecycle hooks | vue | ✅ |
| suggest-vue-lifecycle-fix | vue | compat_llm | Предложение lifecycle hooks | vue | ✅ |
| detect-vue-watch-issues | vue | script | Детекция проблем watch/watchEffect | vue | ✅ |
| suggest-vue-watch-fix | vue | compat_llm | Предложение watch/watchEffect | vue | ✅ |
| detect-vue-provide-inject | vue | script | Детекция неправильного provide/inject | vue | ✅ |
| suggest-vue-provide-inject-fix | vue | compat_llm | Предложение provide/inject | vue | ✅ |
...
| suggest-tailwind-alternatives | tailwind | compat_llm | Предложение Tailwind альтернатив | tailwind | ✅ |
...
| suggest-laravel-backend-fix | laravel-backend | compat_llm | Предложение исправления backend | laravel-vue | ✅ |
...
| suggest-a11y-fix | a11y | compat_llm | Предложение ARIA/accessibility | all | ✅ |
...
| suggest-security-fix | security | compat_llm | Предложение исправления безопасности | all | ✅ |
...
| suggest-perf-optimization | performance | compat_llm | Предложение оптимизации | all | ✅ |
...
| suggest-blade-components | blade | compat_llm | Предложение компонентов вместо includes | laravel | ✅ |
...
| suggest-eloquent-eager-loading | eloquent | compat_llm | Предложение eager loading | laravel | ✅ |
...
| suggest-form-requests | validation | compat_llm | Предложение Form Requests | laravel | ✅ |
...
| suggest-pest-phpunit-tests | testing | compat_llm | Предложение Pest/PHPUnit тестов | laravel | ✅ |
...
| suggest-queue-optimization | queues | compat_llm | Предложение queue optimization | laravel | ✅ |
...
| categoryId | detect (script) | suggest (compat_llm) | apply (agent) |
|------------|-----------------|------------------|---------------|
| inertia | 5 | 5 | 0 |
| vue | 5 | 5 | 0 |
| typescript | 4 | 1 | 0 |
