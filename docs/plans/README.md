...
Work-in-progress items: **[`active/`](active/)**.
...
| [`ai-integration/docs/`](../../ai-integration/docs/README.md) | AI Hub / proxy doc stub |
| [`a2a-server/docs/planning/`](../../a2a-server/docs/planning/README.md) | Roadmap, issues, priorities (server / simulations) |

Normative protocol and architecture: **[`docs/new-request-flow/`](../new-request-flow/)**.
