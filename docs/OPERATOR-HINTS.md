...
Canonical cross-module environment alignment for client, server, and a2a-ai-hub.
...
| `PROMISE_TTL_SECONDS` | `86400` | `86400` | `>= LLM_POLL_TIMEOUT_MS/1000` | a2a-ai-hub promise retention window. |
| `DAEMON_POLL_INTERVAL` | `4.0` | `4.0` | `4.0` (or tuned) | a2a-ai-hub daemon cadence in seconds. |
...
| `FORWARD_TIMEOUT_SECONDS` | `30` | `30` | tuned | a2a-ai-hub proxy forward timeout in seconds. 0 = unlimited. |
| `PROVIDER_TIMEOUT` | `30` | `30` | tuned | a2a-ai-hub provider session timeout in seconds. 0 = unlimited. |
