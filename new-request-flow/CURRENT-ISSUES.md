...
- [`a2a-client/web/js/app-enhancements.js:789`](a2a-client/web/js/app-enhancements.js:789) -
  `fetch('/api/v1/projects', { method: 'POST' })`
- [`a2a-client/web/js/web-api-client.js:7`](a2a-client/web/js/web-api-client.js:7) -
