...
2. Web не может правильно обрабатывать ответы сервера (proposedActions, promiseId)
...
### 2. Отсутствует sessionId и projectId в запросах

**Проблема:** Запросы в симуляциях не содержат обязательных полей.
...
**Решение:**
1. Добавить обязательные поля sessionId и projectId во все запросы
2. Реализовать создание сессий до отправки задачи

---

### 3. Нет хранения сессий на стороне Client
...
### 4. Web UI не управляет панелями сессий
