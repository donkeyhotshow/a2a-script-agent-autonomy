...
| suggest-pinia | state | ollama | Предложение Pinia | vue | ✅ |
| suggest-redux | state | ollama | Предложение Redux | react | ✅ |
| suggest-ngrx | state | ollama | Предложение NgRx | angular | ✅ |
...
| suggest-context | component | ollama | Предложение Context API | react | ✅ |
| suggest-provide-inject | component | ollama | Предложение provide/inject | vue | ✅ |
| detect-memo-opportunities | performance | script | Детекция мемоизации | react | ✅ |
| suggest-usememo | performance | ollama | Предложение useMemo | react | ✅ |
| suggest-computed | performance | ollama | Предложение computed | vue | ✅ |
...
| suggest-code-splitting | performance | ollama | Предложение code splitting | all | ✅ |
...
| suggest-aria-labels | a11y | ollama | Предложение ARIA labels | all | ✅ |
...
| suggest-breakpoints | responsive | ollama | Предложение breakpoints | all | ✅ |
| detect-hooks-rules | hooks | script | Детекция нарушений правил hooks | react | ✅ |
| suggest-custom-hooks | hooks | ollama | Предложение custom hooks | react | ✅ |
...
| suggest-composables | composables | ollama | Предложение composables | vue | ✅ |
...
| suggest-dependency-injection | services | ollama | Предложение DI | angular | ✅ |
| detect-virtual-scroll | performance | script | Детекция виртуализации | all | ✅ |
| suggest-virtual-scroll | performance | ollama | Предложение виртуализации | all | ✅ |
...
| suggest-form-library | forms | ollama | Предложение библиотеки форм | all | ✅ |
...
| suggest-route-guards | routing | ollama | Предложение route guards | all | ✅ |
| detect-css-in-js | styling | script | Детекция CSS-in-JS | all | ✅ |
| suggest-styled-components | styling | ollama | Предложение styled-components | react | ✅ |
| detect-animation-performance | animation | script | Детекция производительности анимаций | all | ✅ |
| suggest-animation-library | animation | ollama | Предложение библиотеки анимаций | all | ✅ |
