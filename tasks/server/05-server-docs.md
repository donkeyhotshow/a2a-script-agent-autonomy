...
- External AI Hub:
  - `ai-integration/docs/*` (if present)
  - Any server integration code (`llm-hub` service, etc.).

## Work to perform

1. **Server architecture doc**
   - Create or refine a server-focused doc (e.g. `docs/new-request-flow/SERVER-ARCHITECTURE.md` or under `a2a-server/docs/`) that explains:
