...
- Architecture / protocol:
  ...
  - `docs/new-request-flow/ACTION-MAP.md`
...
1. **Web UI documentation**
   - Write a dedicated doc (e.g. `new-request-flow/WEB-UI.md` or under `a2a-client/web/docs/`) describing:
     ...
     - How Web talks to Client API:
       ...
       - Expected request and response shapes (link to protocol schemas in `docs/new-request-flow/json-schemas`).
...
2. **Client API (api-server) documentation**
   ...
   - Ensure the documented API matches `docs/new-request-flow/PROTOCOL.md` and `SCHEMAS.md`.
...
4. **Cross-linking and diagrams**
   ...
   - Ensure docs link back to `simulations/SCHEMA.md` and `docs/new-request-flow/SIMULATION-FORMAT.md`.
