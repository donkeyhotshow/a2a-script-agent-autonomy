...
2. **Then session-queue prompts** — Run the flat queue under [`prompts-to-agent-mode/`](../prompts-to-agent-mode/README.md) when the stack is the right surface to verify or execute those tasks.
