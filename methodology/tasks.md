...
## Очередь репозитория (`tasks/`)

- Контракт двух сессий: **`methodology/session-roles.md`** (тип 1 пишет в `tasks/pending/`, тип 2 только оттуда читает и переносит в `tasks/archive/`).
- Описание папок: `tasks/README.md`.
