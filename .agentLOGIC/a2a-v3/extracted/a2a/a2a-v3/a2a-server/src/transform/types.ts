...
export type ServerInterruptTraceEvent =
  ...
  | { kind: 'meta_reasoner_strategy'; strategy: string; reason: string }
  | { kind: 'metacognitive_audit_failed'; issues?: unknown[] }
  | { kind: 'metacognitive_audit_failed_on_truncation'; issues?: unknown[] }
  | { kind: 'metacognitive_audit_failed_on_non_continue'; issues?: unknown[] };
