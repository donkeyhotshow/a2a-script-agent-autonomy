...
7. **Health Checks** – confirm the initial/final readiness probe hits Client API (`http://localhost:5173/api/a2a`), A2A Server (`http://localhost:3000`), Ollama (`http://localhost:11435`), and AI Hub (`http://localhost:11434`).
